...
public class BookAdapter extends ArrayAdapter<Book> {
    ...
    public View getView(int position, View convertView, ViewGroup parent)  {
        ...
        // Find the TextView in the book_list_iteme_list_item.xml layout with the ID book_title_text_view
        TextView BookTitleTextView = (TextView) listItemView.findViewById(R.id.book_title_text_view);

        // Find the TextView in the book_list_iteme_list_item.xml layout with the ID book_author_text_view
